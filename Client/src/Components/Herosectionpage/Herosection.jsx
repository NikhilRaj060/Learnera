...
const slogan = [
  { text: "Transforming", className: "text-blue-500 dark:text-blue-500", },
  { text: "Education", className: "text-blue-500 dark:text-blue-500", },
  { text: "for", className: "text-blue-500 dark:text-blue-500", },
  { text: "the", className: "text-blue-500 dark:text-blue-500", },
  { text: "Modern", className: "text-blue-500 dark:text-blue-500", },
  { text: "Era", className: "text-blue-500 dark:text-blue-500", },
];
