...
function Ui() {
  ...
  useEffect(() => {
    ...
    // try {
    //   axios.get(`process.env.REACT_APP_API_URL/api/courses/${folderName}/${course?.videoNames[0]}`)
    //   .then((res) => {
...
{ image: "/Image/Fire.png", alt: "Best ROI Badge", text: "Best ROI" },
  ...
  const reviewData = [
    ...
    },
    {
      ...
      comment:
        "The Subscription Course Package is an excellent investment for anyone committed to continuous learning and personal growth. Its flexibility, quality content, and supportive environment make it a standout choice in the crowded online learning landscape. I highly recommend Learnera's Life time subscription it to anyone looking to expand their knowledge and skills in a convenient and effective manner. ",
      name: "Roshan Kumar",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      image: "tamanna.jpeg",
      comment:
        "Upon completing each course, learners receive a certificate of completion, which can be a valuable addition to their resume or professional portfolio. The certificates attest to the learner's mastery of the course material and can enhance their credibility in their chosen field and Overall, the Lifetime Membership of Learnera is comprehensive and flexible learning experience that empowers learners to acquire new skills, advance their careers, and pursue their passions effectively and efficiently.",
      name: "Tamanna",
    },
    {
      id: 5,
    ...
    },
    {
      ...
      comment:
        "One of the most impressive aspects of the course package of Learnera is its flexibility. With lifetime access, I could progress through the courses at my own pace, allowing me to balance my learning with other commitments. Additionally, the diverse selection of courses catered to different interests and skill levels, ensuring there was always something new and relevant to explore. I can confidently say that it exceeded my expectations in every aspect.",
      name: "Nafeesa Lachan",
    },
  ];
  ...
  return (
    <>
      <BaseLayout>
        <Helmet>
          <meta charSet="utf-8" />
          <title>Learnera {course?.courseTitle ? `| ${course?.courseTitle}` : ""}</title>
